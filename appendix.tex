...
%\textblockcolour{red}
\includegraphics[width=145mm]{ref_cards/qv1.pdf}
\end{textblock*}
\null\newpage
...
\begin{textblock*}{148mm}(1mm,20mm)
%\textblockcolour{red}
\includegraphics[width=145mm]{ref_cards/qv2.pdf}
\end{textblock*}
\null\newpage
...
\begin{textblock*}{148mm}(1mm,20mm)
%\textblockcolour{red}
\includegraphics[width=145mm]{ref_cards/qp1.pdf}
\end{textblock*}
\null\newpage
...
\begin{textblock*}{148mm}(1mm,20mm)
%\textblockcolour{red}
\includegraphics[width=145mm]{ref_cards/qp2.pdf}
\end{textblock*}
\null\newpage
